(* Note: Too much broken, unable to fix. *)
...
(* Require Import Coq.Sets.Setoidsets. Manual fix - cannot find this library. *)
...
Definition empty_set {U} : Ensemble U := Empty_set U. (* Manual fix -- added Us *)
