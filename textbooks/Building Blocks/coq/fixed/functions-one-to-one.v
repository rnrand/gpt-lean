...
Require Import Psatz. (* Manual - added import *)
...
Locate "mod".
(* Manual fix - moved mod to infix. This definition is still pretty lacking, though. *)
Lemma pigeonhole_principle: forall (n k : nat),
  n > k -> exists i j : nat, i <> j /\ i mod (S k) = j mod (S k).
Proof.
...
(* Manual fix - commented out, doesn't work *)
(*
